...
- (UILabel *)textLabel {
    if (!_textLabel) {
        ...
        _textLabel.font = [UIFont fontWithName:@"经典细圆简" size:14.0f];//[UIFont boldSystemFontOfSize:15.0f];
...
- (UILabel *)detailTextLabel {
    if (!_detailTextLabel) {
        ...
        _detailTextLabel.font = [UIFont fontWithName:@"经典细圆简" size:12.0f];//[UIFont systemFontOfSize:13.0f];
