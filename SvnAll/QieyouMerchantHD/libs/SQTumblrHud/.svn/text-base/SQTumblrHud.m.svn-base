...
static SQTumblrHud *_sharedInstance = nil;

@implementation SQTumblrHud{
...
- (void)configUI {
    ...
    UIView *rect2 = [self drawRectAtPosition:CGPointMake(8, 0)];
    UIView *rect3 = [self drawRectAtPosition:CGPointMake(16, 0)];
...
- (UIView *)drawRectAtPosition:(CGPoint)positionPoint {
    ...
    CGRect rectFrame;
    rectFrame.size.width = 6;
    rectFrame.size.height = 5;
