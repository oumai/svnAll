...
typedef NS_ENUM(NSUInteger, SQPopoverPosition) {
    SQPopoverPositionUp = 1,
    SQPopoverPositionDown,
};

typedef NS_ENUM(NSUInteger, SQPopoverMaskType) {
    SQPopoverMaskTypeBlack,
    SQPopoverMaskTypeNone,
};


@interface SQPopover : UIView
 ...
 */
@property (nonatomic, assign, readonly) SQPopoverPosition popoverPosition;
...
/**
 *  The background of the popover, default is SQPopoverMaskTypeBlack;
 */
@property (nonatomic, assign) SQPopoverMaskType maskType;
