//
//  UIViewController+SQPopupViewController.m
//  QieyouMerchant
//
...
- (SQPopupBackgroundView*)mj_popupBackgroundView {
    return objc_getAssociatedObject(self, kMJPopupBackgroundView);
}

- (void)setMj_popupBackgroundView:(SQPopupBackgroundView *)mj_popupBackgroundView {
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    // BackgroundView
    self.mj_popupBackgroundView = [[SQPopupBackgroundView alloc] initWithFrame:sourceView.bounds];
